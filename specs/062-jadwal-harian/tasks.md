...
- [x] **T1 — App `schedule` + model + registrasi**
...
- [x] **T2 — Logika "hari ini" + endpoint anak**
...
- [x] **T3 — Endpoint orang tua + isolasi**
...
- [x] **T5 — Layar Jadwal anak + navigasi**
